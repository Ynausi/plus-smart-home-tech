...
import ru.yandex.practicum.mapper.SensorEventConverter;
...
public class SensorServiceImpl implements SensorService{
    ...
    public void createSensor(SensorEventProto proto) {
        SensorEventDto dto = sensorEventConverter.fromProto(proto);
        SensorEventAvro avroEvent = sensorEventConverter.toAvro(dto);
