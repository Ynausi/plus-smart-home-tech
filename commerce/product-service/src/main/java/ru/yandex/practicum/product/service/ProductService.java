...
public class ProductService {
    ...
    public List<ProductDto> findAll() {
        return repository.findAllByActiveTrue().stream().map(this::toDto).toList();
    }
    ...
    public List<ProductDto> findByCategory(Long categoryId) {
        ...
        return repository.findAllByCategoryIdAndActiveTrue(categoryId)
                .stream()
                .map(this::toDto)
                .toList();
    }
    ...
    public List<ProductDto> search(String query) {
        return repository.findAllByNameContainingIgnoreCaseAndActiveTrue(query == null ? "" : query)
                .stream()
                .map(this::toDto)
                .toList();
    }
    ...
    private ProductDto toDto(Product p) {
        CategoryDto category = p.getCategory() == null
                ? null
